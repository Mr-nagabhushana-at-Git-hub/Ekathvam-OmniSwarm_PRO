...
### [adversarial-correctness-critic]
...
USER:
## Task
Adversarially audit the correctness and logic of the integrated code. Detect race conditions, resource leaks, and unhandled promises.
...
USER:
## Task
As the engineering department lead (security focus): Audit this repository as your department. Identify w

## Shell Output Context
$ node C:/AGENCY/ORCMEGA/scripts/verify-gate-build.js
[error 1]: Command failed: node C:/AGENCY/ORCMEGA/scripts/verify-gate-build.js
Invalid project directory provided, no such directory: C:\AGENT\Ekathvam-OmniSwarm\.upgrade\staging\lint
✗ next lint failed!
✗ gate validation failed! files will not be accepted.
